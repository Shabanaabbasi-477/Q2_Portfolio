...
function Portfolio() {
  return (
    <>
      <section id="portfolio" className="w-full py-36 px-8 text-center bg-[#a58a6d]">
        <h4 className={`${caveat.className} text-white text-4xl lg:text-5xl`}>
          <span className="text-[#694017]">M</span>y{" "}
          <span className="text-[#694017]">L</span>ast{" "}
          <span className="text-[#694017]">W</span>ork
        </h4>
