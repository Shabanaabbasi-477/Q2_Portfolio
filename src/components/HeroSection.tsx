...
function HeroSection() {
  return (
    <>
      <section className='bg-[#a58a6d] w-full text-center pt-[7.5rem]'>
        <p className='text-[2rem]'>Hey! I'm <span className='text-[#694017]'>Shabana Abbasi</span></p>

        <p className='text-[2rem]'><span className='text-[#694017]'>I</span>'m <span className='text-[#694017]'>A F</span>ront <span className='text-[#694017]'>E</span>nd <span className='text-[#694017]'>W</span>eb <span className='text-[#694017]'>D</span>eveloper</p>
