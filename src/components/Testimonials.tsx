...
function Testimonials() {
  return (
   <>
     <section id="testimonials" className="bg-[#a58a6d] py-40 px-4 md:px-8">
      <div className="text-white text-center">
        <h4 className="text-white text-4xl lg:text-5xl font-[Caveat] ">
          <span>
            <span className="text-[#694017]">W</span>hat{' '}
            <span className="text-[#694017]">O</span>ther{' '}
            <span className="text-[#694017]">P</span>eople{' '}
            <span className="text-[#694017]">S</span>ay
          </span>
        </h4>
