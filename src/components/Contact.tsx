...
function Contact() {
  return (
    <>
      <section id="contact" className="py-40 px-4 md:px-8 bg-[rgb(166,100,34)]">
        <div className="text-center text-white">
          <h4 className="text-4xl lg:text-5xl font-[Caveat]">
            <span>
              <span className="text-[rgb(241,212,183)] ">C</span>ontact{' '}
              <span className="text-[rgb(235,207,179)] ">M</span>e
            </span>
          </h4>
            ...
            <div className="flex flex-col justify-center items-start text-center">
              ...
              <div className="flex mb-12 items-start">
                ...
                <div className="text-start">
                  ...
                  <p className="my-2 text-[#0e0d0d]">I am here to help you</p>
              ...
              <div className="flex mb-12 items-start">
                ...
                <div className="text-start">
                  ...
                  <p className="my-2 text-[#121111]">Mansoura, Egypt</p>
